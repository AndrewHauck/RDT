...
//   The packets, when sent or received via serial, have a format found in "Igniter code\packetProtocol.txt"
//***[ Main Functions ]***
...
class serialPacket
{
  public:
    ...
    char getType() const;  //returns type (1 byte character) of packet
  ...
  private:
    ...
    void setType(char _byte); //set packet type byte
    String m_dataString;
